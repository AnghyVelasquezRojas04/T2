...
public class ClaseMañana extends javax.swing.JFrame {
    ...
    public ClaseMañana(Principal padre) {
        initComponents();
        this.padre = padre;
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Trigonometria");

        lstCurM.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(lstCurM);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        AgregarAlumnoMañana screen = new AgregarAlumnoMañana(this);
    ...
    public void agregarEstudiante(Estudiante estudiante){
        ...
        lstCurM.setModel(listaEstudiantes);
    }   
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        int index = lstCurM.getSelectedIndex();
        if(index == -1){
            JOptionPane.showMessageDialog(
                    this, 
    ...
    private javax.swing.JList<String> lstCurM;
